...
export function renderPages() {
  return new Map([
    ['agent-interview/index.html', interviewLanding(layout)],
    ...interviewNotes.map(note => [`agent-interview/${note.route}/index.html`, interviewArticle(layout, note)]),
